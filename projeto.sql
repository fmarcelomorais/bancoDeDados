...
SELECT NOME, SEXO FROM CLIENTE
    WHERE SEXO = 'M'; /* SELECAO O WHERE É CLAUSULA DE SELECAO*/
...
INNER JOIN ENDERECO E
ON C.IDCLIENTE = E.ID_CLIENTE
ORDER BY NOME DESC; /* SEMPRE NO FINAL*/
...
INNER JOIN ENDERECO E
ON C.IDCLIENTE = E.ID_CLIENTE
ORDER BY NOME, CPF ASC; /* SEMPRE NO FINAL*/
...
/*mysql> STATUS *//* STATUS DO SERVIDOR */
